...
const { getAssets, getAsset, createAsset, updateAsset, deleteAsset, getAssetHistory, getAssetRisk,getAssetMaintenance, addAssetFailure } = require('../controllers/asset.controller');
...
router.get('/:id/maintenance', authenticateToken, getAssetMaintenance);
